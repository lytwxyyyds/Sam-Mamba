...
class Trainer(object):
    ...
    def training(self):
        ...
        for _ in tqdm(range(elem_num)):
            ...
            lovasz_loss = L.lovasz_softmax(
                F.softmax(output_1, dim=1), labels, ignore=255)
    ...
    def validation(self):
        ...
        # Initialize best_iou and best_f1_score to keep track of the best values
        best_iou = -1
        best_f1_score = -1
        ...
        with torch.no_grad():
            ...
            print(f'Best IoU is {best_iou}, Best F1 score is {best_f1_score}')
...
def main():
    ...
    parser.add_argument('--train_dataset_path', type=str,
                        default=r'F:\lyt\levircd+')
    parser.add_argument('--train_data_list_path', type=str,
                        default=r'F:\lyt\levircd+\list\train.txt')
    parser.add_argument('--test_dataset_path', type=str,
                        default=r'F:\lyt\levircd+')
    parser.add_argument('--test_data_list_path',
                        type=str, default=r'F:\lyt\levircd+\list\test.txt')
