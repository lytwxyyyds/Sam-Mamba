...
def make_data_loader(args, **kwargs):  # **kwargs could be omitted
    if 'SYSU2' in args.dataset or 'LEVIR-CD+' in args.dataset or 'LEVIR+' in args.dataset:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', type=str, default='D:/Workspace/Python/STCD/data/ST-SYSU2-BCD')
    parser.add_argument('--data_list_path', type=str, default='./ST-SYSU2-BCD/train_list.txt')
